...
## 🚀 <span style="color:#00F0FF;">Developer Snapshot</span>

<table align="center" border="1" style="border-collapse: collapse; border-color: #30363d; width: 100%;">
  <tr>
    <td width="50%" valign="top">
      <h3><img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Rocket.png" width="25"> What I'm Up To</h3>
      <ul>
        <li>🔭 <b>Building:</b> Flutter apps (<i>A-lens, CookEase, Aksh English, Notes app</i>)</li>
        <li>🌱 <b>Learning:</b> AI, Data Science, Computer Vision, React, Next.js, System Automation</li>
        <li>📦 <b>Open Source:</b> Author of Python Package <a href="#"><b><code>inf_STT</code></b></a></li>
        <li>💼 <b>Portfolio:</b> <a href="https://ashish-portfolio-new-one.vercel.app/">Check out my work here</a></li>
        <li>♟️ <b>Fun Fact:</b> 2x Internal SIH Winner & competitive chess player!</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>👑 <b>Chief Technology Officer</b> <br><i>@ NextGen Tech Connect (Feb 2026 - Present)</i></li>
        <li>💻 <b>Web Developer (Intern)</b> <br><i>@ inNEXTin (Nov 2025 - Feb 2026)</i></li>
        <li>📊 <b>Data Analytics & Mgmt Intern</b> <br><i>@ Archirush Technology (DezignBank)</i></li>
        <li>🗄️ <b>Data Manager (Intern)</b> <br><i>@ ORIONN ARCHITECTS (Jun 2025 - Aug 2025)</i></li>
      </ul>
    </td>
  </tr>
</table>
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=aashiskr&label=Profile%20Views&color=ff69b4&style=for-the-badge&logo=github" alt="Views" />
</div>
